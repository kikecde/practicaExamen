<!-- Add Movil Modal -->
<div class="modal fade" id="addMovil" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-simple modal-add-Movil">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        <div class="text-center mb-4">
          <h3>Registrar Nuevo Movil</h3>
          <p>Creación/Modificación de datos de moviles requerira auditoría por CEO.</p>
        </div>
        <form id="addNewMovilForm" class="row g-3" action="{{ route('list.store') }}" method="POST">
          @csrf
          @method('PUT')
