<?php
  ...
  return [
    ...
    "templateFree" => false,
    "templateDescription" => "Plataforma del Sistema Sanitario de la Décima Región Sanitaria",
    "templateKeyword" => "décima region sanitaria, médicos, enfermeros, plataforma, salud",
